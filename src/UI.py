...
class MainWindow(QMainWindow):
    ...
    def insertElement(self, string):
        ...
        if string == 'type math':
            ...
            self.elementPreviewButton = QPushButton("Preview")
            ...
            self.elementBodyStackPane = QStackedLayout(self)
            self.elementVBoxButton = QVBoxLayout(self)
            self.elementSubmitButton = QPushButton('Upload Image')

            self.elementSubmitButton.clicked.connect(self.fileUpload)
            self.elementVBoxButton.addWidget(self.elementSubmitButton)
            self.elementPreviewButton = QPushButton("Preview")
            self.elementVBoxButton.addWidget(self.elementPreviewButton)
            self.elementPreviewButton.clicked.connect(self.preview)
            ...
            # self.elementVBoxButton.addWidget(self.fileUploadButton)
            # self.elementVBoxButton.addWidget(self.elementSubmitButton)
            # self.elementPreviewButton = QPushButton("Preview")
            # self.elementVBoxButton.addWidget(self.elementPreviewButton)
            # self.elementPreviewButton.clicked.connect(self.preview)
